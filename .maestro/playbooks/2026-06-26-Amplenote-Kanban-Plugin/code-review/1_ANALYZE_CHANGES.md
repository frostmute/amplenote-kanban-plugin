...
- [x] **Validate PR URL**: If the PR URL above is still the placeholder `https://github.com/USER/PROJECT/pull/XXXX`, stop and instruct the user to update the URL before re-running. Do not proceed with any subsequent tasks.

<!-- maestro:halt: PR URL is still a placeholder (https://github.com/USER/PROJECT/pull/XXXX). Please update it before running the playbook. -->
...
- [ ] **Write REVIEW_SCOPE.md**: Create `/Users/thewytchhaus/Documents/GitHub/amplenote-kanban-plugin/.maestro/playbooks/2026-06-26-Amplenote-Kanban-Plugin/REVIEW_SCOPE.md` with:
